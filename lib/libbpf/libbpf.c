...
static const struct bpf_sec_def section_defs[] = {
	...
	SEC_DEF("cgroup/post_autobind",	CGROUP_SOCK, BPF_CGROUP_INET_POST_AUTOBIND, SEC_ATTACHABLE | SEC_SLOPPY_PFX),
	SEC_DEF("cgroup/tw_close",	CGROUP_SOCK, BPF_CGROUP_TWSK_CLOSE, SEC_ATTACHABLE | SEC_SLOPPY_PFX),
	SEC_DEF("cgroup/udp_unhash",	CGROUP_SOCK, BPF_CGROUP_UDP_UNHASH, SEC_ATTACHABLE | SEC_SLOPPY_PFX),
